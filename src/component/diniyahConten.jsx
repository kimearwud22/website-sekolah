      ...
      <div className="container mt-3">
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col">
              <h4 className="text-center">What Is PDF AInul Huda?</h4>
              <p className="txt">
                PDF Ainul Huda atau Pendidikan Diniah Formal Ainul Huda merupakan sekolah yang dirintis oleh
                Yayasan Pondok Pesantren Islamiyah Salafiyah Ainul Huda Yang
                berdiri pada tahun 2020,Sekolah yang mempersiapkan generasi
